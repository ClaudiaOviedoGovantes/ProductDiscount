    ...
    */
    ...
    await queryInterface.bulkInsert('Restaurants',
      [
        ...
        { name: '100 montaditos', description: 'A fun and varied way to enjoy food. A place to share experiences and get carried away by the moment.', address: 'Józefa 34, Kraków, Poland', postalCode: '123-4567', logo: 'public/restaurants/100MontaditosLogo.jpeg', heroImage: 'public/restaurants/100MontaditosHero.jpeg', url: 'http://spain.100montaditos.com/', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'info@restaurant.com', phone: '+48123456789', createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'online', discountPercentage: 10 },
        { name: '1000 products', description: '1000 products', address: 'Józefa 34, Kraków, Poland', postalCode: '123-4567', url: 'http://1000products.com/', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'info@restaurant.com', phone: '+48123456789', createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'online', discountPercentage: 10 },
        { name: '0 products', description: '0 products', address: 'Józefa 34, Kraków, Poland', postalCode: '123-4567', url: 'http://1000products.com/', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'info@restaurant.com', phone: '+48123456789', createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'closed', discountPercentage: 10 },
